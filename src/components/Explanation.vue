<template lang="html">
    <div id="section-explanation" class="q-pa-md-xl q-pa-md q-my-xl">
      <div class="row">
        <div class="col-md-5">
          <h1 class="text-h5 q-mb-none section-header text-underlined">EXPLANATION</h1>
          <h2 class="text-bold q-mt-none q-mt-xl q-mb-md">Why this donation ?</h2>
          <p>A few days ago, one of our closest IRL friend lost his father just one week after losing his brother, two people he was living with since he was a child.</p>
          <p>While we try to spend most of our time with him to cheer him up, we felt that it was not enough. This is why we thought about a donation-based crowdfunding.</p>
